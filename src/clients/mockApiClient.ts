...
export function userLeavesTeachingInstance(token: string, coursekey: string, teacher: boolean): any {
  return null
}

export function teacherDeletesTeachingInstance(token: string, coursekey: string, teacher: boolean): any {
  return null
}
